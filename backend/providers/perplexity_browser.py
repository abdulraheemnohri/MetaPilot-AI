"""
Perplexity Browser Provider for MetaPilot AI

Implementation of AIProvider for Perplexity AI via browser automation.
"""
...
class PerplexityBrowserProvider(BrowserAIProvider):
    """
    Perplexity browser-based provider.
    """
    ...
    async def chat(
        ...
        **kwargs,
        ...
        async with self.browser_manager.get_page() as page:
            ...
            # Wait for response
            await asyncio.sleep(8) # Perplexity takes longer sometimes
            ...
            return ChatResponse(
                text=text,
                model=model or "perplexity-browser",
                provider=self.name,
