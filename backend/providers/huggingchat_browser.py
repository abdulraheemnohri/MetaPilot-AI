"""
HuggingChat Browser Provider for MetaPilot AI

Implementation of AIProvider for HuggingChat via browser automation.
"""
...
class HuggingChatBrowserProvider(BrowserAIProvider):
    """
    HuggingChat browser-based provider.
    """

    provider_type = ProviderType.LOCAL
    name = "HuggingChat (Browser)"
    ...
    async def chat(
        ...
        **kwargs,
        ...
        async with self.browser_manager.get_page(conversation_id=kwargs.get("conversation_id")) as page:
            ...
            return ChatResponse(
                text=text,
                model=model or "huggingchat-browser",
                provider=self.name,
